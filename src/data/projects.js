...
export const projectsData = [
  {
    ...
    fullDesc:
      "modern fitness salonları için tasarlanmış kapsamlı bir yönetim platformu. üye kayıt ve takip sistemi, kişisel antrenör randevu yönetimi, online ödeme altyapısı, beslenme programı takibi ve performans analitiği içerir. responsive tasarımı sayesinde hem web hem mobil cihazlarda kusursuz çalışır.",
    features: [
  ...
  },
  {
    ...
    fullDesc:
      "hem gayrimenkul hem de araç satışı için tasarlanmış çift taraflı marketplace platformu. gelişmiş filtreleme sistemi, coğrafi konum bazlı arama, anlık mesajlaşma, fiyat takip sistemi ve güvenli ödeme altyapısı ile kullanıcılarına en iyi deneyimi sunar.",
    features: [
